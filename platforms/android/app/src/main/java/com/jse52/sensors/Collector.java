...
public class Collector {
    ...
    public void setSampleRate(float sampleRate) {
        this.sleepTime = (long) sampleRate;
    }

//    public void setSampleRate(SampleRate sampleRate) {
////        this.sleepTime = (long) Long.valueOf(sampleRate.toString());
////    }
    ...
    public void stop() {
        if (this.collector != null) {
            ...
            try {
                this.collector.join(); // Wait for the thread to finish.
        ...
        public void run() {
            while (!Thread.interrupted()) {
                ...
                for (SampleListener l : listeners)
                    l.onSampleReceived(data.clone(), meta, timestamp);
