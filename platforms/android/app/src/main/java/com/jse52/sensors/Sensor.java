...
public abstract class Sensor {
     ...
     */
    public final SensorMetaData getMetaData() {
        return this.meta;
    }
    ...
    protected void update(Object... data) {
        synchronized (this.data) {
            if (this.data.size() != data.length) {
                Log.e("Sensor", "Invalid data lengths in update().");
                return;
            }
    ...
    public void setAveraging(int windowSize, AverageWeighting weighting) {
        ...
        this.data.clear();
        for (int i = 0; i < this.meta.getDimension(); ++i)
    ...
    public static class SensorMetaData {
         ...
         */
        public Types[] getDimensionTypes() {
    ...
    class SlidingWindowQueue<T> {
        ...
        public synchronized void add(T item) {
            ...
            if (size > queue.length)
                Log.e("SlidingWindowQueue", "Size is greater than expected in add()!");
        }
        ...
        public synchronized T poll() {
            ...
            T result = null;
            try {
                result = (T) queue[head]; // Save the item at the head.
            } catch (ClassCastException e) {
                Log.e("SlidingWindowQueue", "Problem casting item in poll().");
            }
        ...
        public synchronized T peek() {
            ...
            try {
                ...
                Log.e("SlidingWindowQueue", "Problem casting item in peek().");
            }
            return result;
        }
        ...
        public synchronized T getAt(int i) {
            T result = null;
            try {
                result = (T) queue[(head + i) % queue.length];
            } catch (ClassCastException e) {
                Log.e("SlidingWindowQueue", "Problem casting item in getAt(i).");
            }
            return result;
        }
